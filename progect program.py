...
class Bullet:
    def __init__(self, x, y, x1, y1, screen):
        self.vstrel = False
        self.screen = screen
        self.x_bul = x
        self.y_bul = y
    ...
    def draw_bullet_blue(self):
        global lastMove_blue
        if lastMove_blue == 'up':
            self.screen.blit(bullet_img[0], (self.x1_bul, self.y1_bul))
            self.y1_bul += self.speed_bul

        if lastMove_blue == 'down':
            self.screen.blit(bullet_img[0], (self.x1_bul, self.y1_bul))
            self.y1_bul -= self.speed_bul

        if lastMove_blue == 'laft':
            self.screen.blit(bullet_img[0], (self.x1_bul, self.y1_bul))
            self.x1_bul -= self.speed_bul
...
class Level(Bullet):
    def __init__(self, screen):
        ...
        self.ed_naz1 = False
        self.stop1 = True
        self.vper_stop1 = False
        self.naz_stop1 = False
        self.laft_stop1 = False
        self.right_stop1 = False
